  ...
  return (
    <>
      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.desktop}>
          ...
          >
            ...
            <div className={styles.text + ' text-white text-center'}>EXCLUSIVE ACCESS</div>
          </div>
      ...
      <div className={styles.taskbar}>
        <div
          ref={dropdownRef}
          className={`${styles.startMenu} ${isActive ? styles.active : styles.inactive
            }`}
        >
          ...
          <div className={styles.startMenuItems}>
            <section className={styles.menuCont}>
              ...
              >
                <div style={{ margin: "7px" }}>
                  {" "}
                  <Image width={16} height={16} src="/calendar-1.png" alt="comp" />
                </div>
